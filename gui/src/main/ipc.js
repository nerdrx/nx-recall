...
export function registerIpc({ voice, openVoiceDebug, request, setPaused, getState, showWindow, relaunch, captions, notify, chooseFolder, openFolder, chooseBackupFolder, openBackupFolder }) {
  ...
  ipcMain.handle('recall:voice:correctHeard', (_e, id, text) => voice.correctHeard(id, text));
